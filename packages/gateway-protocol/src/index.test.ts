  ...
  it("accepts provider, model, voice, mode, transport, and brain overrides", () => {
    expect(
      validateTalkClientCreateParams({
        ...
        brain: "agent-consult",
        participant: {
          participant_id: "participant-claude-1",
          work_session_id: "work-session-1",
          source_lane: "watercooler",
          surface_type: "claude",
          surface_label: "Claude sidecar",
          session_ref: "agent:main:main",
          role: "interactive_controller",
          trust_level: "external",
          external_client: true,
          status: "attached",
          attached_at: "2026-05-05T12:00:00.000Z",
          last_seen_at: "2026-05-05T12:00:00.000Z",
        },
        continuity: {
          schema_version: "cinder-2026-06-30",
          state: "working",
          ...
          lease: {
            ...
            work_session_id: "work-session-1",
            participant_id: "participant-claude-1",
            owner_agent: "claude-proposer",
            holder_participant_id: "participant-claude-1",
            holder_surface_type: "claude",
            holder_surface_label: "Claude sidecar",
            execution_mode: "guided",
            execution_surface: "claude-proposer",
            scope_type: "worktree",
            repo: "watercooler",
            worktree: "/worktrees/watercooler",
            branch: "smolder/session-continuity",
            allowed_actions: ["read", "checkpoint", "request_write_access"],
            issued_at: "2026-05-05T12:00:00.000Z",
            expires_at: "2026-05-05T13:00:00.000Z",
            refresh_deadline: "2026-05-05T12:45:00.000Z",
            status: "held",
          },
          next_action: "Ask for governed approval before executing privileged work.",
    ...
    expect(
      validateTalkEvent({
        ...
        continuity: {
          ...
          participants: [
            {
              participant_id: "participant-human-1",
              work_session_id: "work-session-1",
              source_lane: "watercooler",
              surface_type: "desktop_helper",
              surface_label: "Mission Control",
              session_ref: "mc-session-1",
              role: "supervisor",
            ...
            {
              participant_id: "participant-codex-1",
              work_session_id: "work-session-1",
              source_lane: "watercooler",
              surface_type: "codex",
              surface_label: "Codex sidecar",
          ...
          checkpoints: [
            {
              ...
              state: "working",
              objective: "Bridge handoff",
              current_summary: "Ready for handoff",
              current_goal: "Wait for governed lease state.",
              current_worker: "codex-proposer",
              current_steering_client: "Codex sidecar",
              next_step: "Request write access through operator flow.",
              resume_label: "Resume bridge handoff",
              handoff_label: "Bridge handoff",
            },
          ],
          ledger_events: [
            {
              ...
              participant_id: "participant-codex-1",
              correlation_id: "corr-1",
              actor: "codex-proposer",
              source: "control-plane",
              source_lane: "watercooler",
              source_surface: "codex",
              timestamp: "2026-05-05T12:00:00.000Z",
              summary: "Bridge handoff",
            },
          ],
          warnings: ["External clients must request governed write access."],
        },
        payload: { source: "ptt" },
      }),
    ).toBe(true);
      ...
      validateTalkSessionCreateParams({
        ...
        continuity: {
          ...
          handoff: {
            ...
            owner: "smolder",
            source_lane: "watercooler",
            handoff_from: "participant-human-1",
            handoff_to: "participant-codex-1",
            execution_target: "codex-proposer",
            execution_mode: "guided",
            participant_role: "interactive_controller",
            state: "request",
            next_action: "Join the governed room and wait for lease state.",
            expected_confirmation: "checkpoint",
          },
        },
      }),
    ).toBe(true);
    expect(
      validateTalkSessionJoinResult({
        ...
        continuity: {
          ...
          task_id: "task-1",
          work_session_id: "work-session-1",
          active_participant_id: "participant-codex-1",
          lease: {
            lease_id: "lease-1",
            task_id: "task-1",
            work_session_id: "work-session-1",
            participant_id: "participant-codex-1",
            owner_agent: "codex-proposer",
            holder_participant_id: "participant-codex-1",
            holder_surface_type: "codex",
            holder_surface_label: "Codex sidecar",
            execution_mode: "guided",
            execution_surface: "codex-proposer",
            scope_type: "worktree",
            issued_at: "2026-05-05T12:00:00.000Z",
            expires_at: "2026-05-05T12:05:00.000Z",
            refresh_deadline: "2026-05-05T12:04:00.000Z",
            status: "held",
          },
        },
        room: {
